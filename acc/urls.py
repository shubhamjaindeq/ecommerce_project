...
from acc.views import ApprovalView, UserProfileView, UserUpdateView, \
     ShopSignupFormView, ShopUpdateView, RequestsView, ShopProfileView , \
     UserListView , AddUserFormView , UserUpdateByAdminView , \
     UserDeleteByAdmin, \
     SalesReportView, UserOrderView, OrderDetailForAdminView, \
